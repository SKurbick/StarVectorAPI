        ...
        *,
        ...
        try:
            if close_old:
                ...
                status_data = await self.card_status_repo.get_status_by_nm_and_account([(source_wb_card, source_wb_client.account)])
                current_status = status_data.get((source_wb_card, source_wb_client.account))
