...
from app.api.endpoints import (article_router, card_data_router, price_discount_router, favicon_router,
                               ...
                               orders_history_router, product_note_router, upload_cards_router, subject_data_router, marketplace_charcs_router)
...
app.include_router(marketplace_charcs_router, prefix="/api")
